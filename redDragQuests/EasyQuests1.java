...
@ScriptManifest(authors = "Marko", category = "RedDrags", name = "4. Easy quests [PT2]", description = "3 easy quests [START IN LUMBRIDGE WITH INVENTORY: SPADE, BUCKET, 5+ VTAB, BANK: 60+ PURE ESS]", version = 1.1)
public class EasyQuests1 extends Script implements Painting, Ending {
    ...
    public boolean started_peril = true; //temp true
    public boolean talked_door1 = true; //temp true
    public boolean dog_killed = true; //temp true
    public boolean talked_door2 = true; //temp true
    public boolean talked_king2 = true; //temp true

    public boolean inside_temple = true; //temp true !

    public boolean killed_30 = true; //temp true
    public boolean talked_drezel1 = true; //temp true
    public boolean talked_drezel2 = true; //temp true
    public boolean items_used = true; //temp true
    ...
    public void startPeril() {
        ...
        if (hasItem(WOLFBANE)) {
            ...
            if (isInsideDrezel() && tab.length > 0) {
                ...
                botstatus = "Walking to bank";
                WebWalking.walkToBank();
            } else if (Banking.isInBank() && Inventory.getCount(PURE_ESS_ID) < 20 && Inventory.getCount(PURE_ESS_ID) < 20) {
